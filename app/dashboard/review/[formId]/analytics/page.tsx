...
import { ReviewForm, ReviewSubmission, ReviewAnalytics as ReviewAnalyticsType } from '../../../../lib/review-types';
...
export default function ReviewAnalyticsPage() {
  ...
  const [analytics, setAnalytics] = useState<ReviewAnalyticsType | null>(null);
  ...
  const loadData = async () => {
    ...
    try {
      ...
      // Load analytics
      const analyticsResult = await getReviewFormAnalytics(formId);
